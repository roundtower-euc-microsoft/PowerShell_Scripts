...

{
    ...
    "description":  "Assign this policy to all users, including BYOD users. Windows 10 compliance settings to apply immediately. \n",
    "displayName":  "[ITPM Baseline] Windows 10: Immediate",
...
{
    "@odata.type":  "#microsoft.graph.windows10CompliancePolicy",
    "description":  "Assign this policy to all users including BYOD users. Windows 10 compliance settings to apply with 24 hour grace period.",
    "displayName":  "[ITPM Baseline] Windows 10: Delayed",
    "passwordRequired":  false,
    "passwordBlockSimple":  false,
    "passwordRequiredToUnlockFromIdle":  false,
    "passwordMinutesOfInactivityBeforeLock":  null,
...
$WIPMAM = @"
{
    ...
    "description":  "Use this policy only if you plan to allow unmanaged Windows 10 devices to connect to your corporate data using Microsoft 365 desktop applications. Do not assign this policy until you have added your approved apps and network locations.",
...

{
    ...
    "description":  "Assign this policy to Company owned Windows 10 devices. Allows the user to perform a self-service Autopilot reset.",
    "displayName":  "[ITPM Corporate] Windows 10: Allow Autopilot Reset",
...

{
    ...
    "deviceManagementApplicabilityRuleOsVersion":  null,
    "deviceManagementApplicabilityRuleDeviceMode":  null,
    "description":  "Assign this profile to Company owned Windows 10 devices. Prevents the sign-in animation sequence for users signing into the device for the first time.",
    "displayName":  "[ITPM Corporate] Windows 10: Disable first sign-in animation",
    "omaSettings":  [
                        {
...

{
    ...
    "displayName":  "[ITPM Corporate] Chromium Edge for Windows 10",
...
Write-Host
Write-Host "Adding Windows 10 Immediate policy..." -ForegroundColor Yellow
Add-DeviceCompliancePolicybaseline -JSON $Comp_Win10Immediate 
Write-Host
Write-Host "Adding Windows 10 Delayed policy..." -ForegroundColor Yellow
Add-DeviceCompliancePolicybaseline -JSON $Comp_Win10Delayed
Write-Host
} else
...
Write-Host "Adding Default update ring for Windows 10..." -ForegroundColor Yellow
Add-DeviceConfigurationPolicy -JSON $Config_Win10DefaultUpdate
Write-Host
Write-Host "Adding Delayed update ring for Windows 10..." -ForegroundColor Yellow
Add-DeviceConfigurationPolicy -JSON $Config_Win10DelayedUpdate
Write-Host
} else
...
if ($Answer -eq 'y' -or $Answer -eq 'yes') {
Write-Host "Adding Windows 10 app packages..." -ForegroundColor Cyan
Write-Host
