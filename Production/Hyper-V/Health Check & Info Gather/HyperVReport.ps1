...
Created by: Corey St. Pierre, Sparkhound, LLC
Version: 1.0
Uses: Use at own risk. I'm not responsible for anything that this script does if not used properly
Thanks to: Google and MSDN blogs
